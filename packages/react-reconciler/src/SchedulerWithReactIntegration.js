...
export function getCurrentPriorityLevel(): ReactPriorityLevel {
  switch (Scheduler_getCurrentPriorityLevel()) {
    case Scheduler_ImmediatePriority: // 及时优先级
      return ImmediatePriority;
    case Scheduler_UserBlockingPriority:  // 调度器_用户阻塞优先级
      return UserBlockingPriority;
    case Scheduler_NormalPriority:    // 调度员_正常优先级
      return NormalPriority;
    case Scheduler_LowPriority: // 调度员_低优先级
      return LowPriority;
    case Scheduler_IdlePriority:  // 调度器_空闲优先级
      return IdlePriority;
    default:
